...
class KotlinCheat(val name: String, private val age: Int = 22) {

    private var message: String = "kotlin is cool!"
    ...
    init {
        ...
        println("Your sum of a and d is ${a + d}")
    }
